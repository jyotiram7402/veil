...
export function UserChat({
  ...
  usePresence(me);
  useTypingPrune();
  useEphemeralSession(); // sign out + redirect on tab background
  ...
  return (
    <ScreenGuard watermark={`@${me.username}`}>
      <div className="flex h-[100dvh] flex-col chat-bg">
        <header className="flex h-14 items-center gap-3 border-b border-border/60 px-3 bg-card/40 backdrop-blur">
          <UserAvatar
